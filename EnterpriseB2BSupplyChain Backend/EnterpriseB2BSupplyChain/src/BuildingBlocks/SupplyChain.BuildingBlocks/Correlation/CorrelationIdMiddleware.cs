...
namespace SupplyChain.BuildingBlocks.Correlation;
...
/// controllers, and handlers — including the exception handler — see the correlation ID.
/// </summary>
public sealed class CorrelationIdMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        // carries {CorrelationId} — works seamlessly with UseSerilogRequestLogging.
    ...
    private static string ResolveCorrelationId(HttpContext context)
    {
        ...
        // Fall back to a short GUID — no dashes, lowercased, first 32 chars.
