namespace SupplyChain.BuildingBlocks.Exceptions;

/// <summary>
/// HTTP 400 — The request payload failed validation rules.
...
/// <summary>HTTP 403 — The caller is authenticated but not authorized for this action.</summary>
...
/// <summary>HTTP 409 — The request conflicts with current resource state (e.g. duplicate, concurrency).</summary>
