  ...
  template: `
    <div class="otp-page">
      ...
      <div class="otp-form">
        ...
        <div class="otp-timer">
          <span *ngIf="countdown > 0" class="otp-timer__text">
...
export class VerifyOtpComponent implements OnInit, OnDestroy {
  ...
  verify(): void {
    ...
    this.authService.verifyRegistrationOtp(this.email, this.otpValue).subscribe({
      next: () => {
        this.loading = false;
        this.router.navigate(['/auth/pending-approval'], { state: { email: this.email } });
      },
      error: () => {
        this.loading = false;
        this.hasError = true;
